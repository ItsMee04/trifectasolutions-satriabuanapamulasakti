        ...
        <div class="card-body">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h5 class="card-title">Daftar Backup</h5>
                    </div>
            ...
            <div class="table-responsive">
                <table class="table table-nowrap table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr v-else-if="!paginatedBackup || paginatedBackup.length === 0">
                            <td colspan="7" class="text-center p-5">Tidak ada data.</td>
                        </tr>

                        <template v-else>
                            <tr v-for="(item, index) in paginatedBackup" :key="item.id" class="text-center">
                                ...
                                <td>
                                    <div class="actions d-flex justify-content-center">
                                        <a @click="handleDownload(item)" class="btn btn-sm bg-success-light me-2">
            ...
            <div v-if="filteredBackup.length > 0" class="d-flex justify-content-between align-items-center p-3">

                <div class="text-muted small">
                    Showing {{ ((currentPage - 1) * 10) + 1 }}
                    to {{ Math.min(currentPage * 10, filteredBackup.length) }}
                    of {{ filteredBackup.length }} entries
                </div>
