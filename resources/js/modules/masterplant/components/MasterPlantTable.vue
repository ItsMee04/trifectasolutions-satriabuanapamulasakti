<template>
    <div class="card card-table">
        <div class="card-body">
            ...
            <div v-if="filteredMasterPlant.length > 0" class="d-flex justify-content-between align-items-center p-3">

                <div class="text-muted small">
                    Showing {{ ((currentPage - 1) * 10) + 1 }}
                    to {{ Math.min(currentPage * 10, filteredMasterPlant.length) }}
                    of {{ filteredMasterPlant.length }} entries
                </div>
