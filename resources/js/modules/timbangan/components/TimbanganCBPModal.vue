<template>
    <div class="modal fade" id="modalConcreteBatchingPlant" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="modalEditLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-primary">
                        {{ isEdit ? 'EDIT CONCRETE BATCHING PLANT' : 'TAMBAH CONCRETE BATCHING PLANT' }}
                    </h5>
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formConcreteBatchingPlant.tanggal" type="date" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <Multiselect v-model="formConcreteBatchingPlant.material_id" :options="materialList"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <Multiselect v-model="formConcreteBatchingPlant.kendaraan_id" :options="kendaraanList"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <Multiselect v-model="formConcreteBatchingPlant.driver_id" :options="driverList"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formConcreteBatchingPlant.berattotal" type="text" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formConcreteBatchingPlant.beratkendaraan" type="text"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <Multiselect v-model="formConcreteBatchingPlant.beratjenis_id" :options="beratjenisList"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <Multiselect v-model="formConcreteBatchingPlant.customer_id" :options="customerList"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formConcreteBatchingPlant.jarakawal" type="text" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formConcreteBatchingPlant.jarakakhir" type="text" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formConcreteBatchingPlant.jarak" type="number" step="0.01" class="form-control"
                                ...
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        <label>Volume ({{ selectedMaterialSatuan }}) <span
                                                class="login-danger">*</span></label>
                                        <input v-model="formConcreteBatchingPlant.volume" type="number" step="0.01" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formConcreteBatchingPlant.beratmuatan" type="text" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formConcreteBatchingPlant.jenis" type="text" class="form-control"
