<template>
    <div class="modal fade" id="modalAsphaltMixingPlant" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="modalEditLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-primary">
                        {{ isEdit ? 'EDIT ASPHALT MIXING PLANT' : 'TAMBAH ASPHALT MIXING PLANT' }}
                    </h5>
                ...
                <form @submit.prevent="handleSubmit">
                    <div class="modal-body p-4">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formAsphaltMixingPlant.tanggal" type="date" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <Multiselect v-model="formAsphaltMixingPlant.material_id"
                                            :options="materialList" :searchable="true" placeholder="Pilih Material"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <Multiselect v-model="formAsphaltMixingPlant.kendaraan_id"
                                            :options="kendaraanList" :searchable="true" placeholder="Pilih Kendaraan"
                                            noOptionsText="Memuat data..."
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <Multiselect v-model="formAsphaltMixingPlant.driver_id" :options="driverList"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formAsphaltMixingPlant.berattotal" type="text"
                                            class="form-control" :class="{ 'is-invalid': errors.berattotal }">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formAsphaltMixingPlant.beratkendaraan" type="text"
                        ...
                        <div class="row">
                            <div class="col-md-6" v-if="!isKategoriAspal">
                                <div class="form-group local-forms mb-3">
                                    <label>Berat Jenis <span class="login-danger">*</span></label>
                                    <Multiselect v-model="formAsphaltMixingPlant.beratjenis_id"
                                        :options="beratjenisList" :searchable="true" placeholder="Pilih Berat Jenis"
                                        :class="{ 'is-invalid': errors.beratjenis_id }" />
                                </div>
                            </div>
                            <div :class="[isKategoriAspal ? 'col-md-12' : 'col-md-6']">
                                <div class="form-group local-forms mb-3">
                                    <label>Customer <span class="login-danger">*</span></label>
                                    <Multiselect v-model="formAsphaltMixingPlant.customer_id" :options="customerList"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formAsphaltMixingPlant.jarakawal" type="text"
                                            class="form-control" :class="{ 'is-invalid': errors.jarakawal }">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formAsphaltMixingPlant.jarakakhir" type="text"
                                            class="form-control" :class="{ 'is-invalid': errors.jarakakhir }">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formAsphaltMixingPlant.jarak" type="number" step="0.01"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formAsphaltMixingPlant.volume" type="number" step="0.01"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formAsphaltMixingPlant.beratmuatan" type="text"
                                            class="form-control" :class="{ 'is-invalid': errors.beratmuatan }" readonly>
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formAsphaltMixingPlant.jenis" type="text" class="form-control"
...
const handleSubmit = async () => {
    await submitAsphaltMixingPlant();
}
