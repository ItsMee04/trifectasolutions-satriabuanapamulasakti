        ...
        <div class="cbp-navigation mb-4">
            <div class="nav-wrapper">
                ...
                <button type="button" class="nav-item">
                    ...
                    <div class="nav-content">
                        <span class="nav-title">Semen</span>
                        <span class="nav-subtitle">Data semen</span>
                    </div>
                </button>
                ...
                <button type="button" class="nav-item">
                    ...
                    <div class="nav-content">
                        <span class="nav-title">Obat</span>
                        <span class="nav-subtitle">Chemical material</span>
                    </div>
                </button>
                ...
                <button type="button" class="nav-item">
                    ...
                    <div class="nav-content">
                        <span class="nav-title">Ready Mix</span>
                        <span class="nav-subtitle">Beton siap pakai</span>
                    </div>
                </button>
                ...
                <button type="button" class="nav-item">
                    ...
                    <div class="nav-content">
                        <span class="nav-title">Uditch & Kanstin</span>
                        <span class="nav-subtitle">Produk beton</span>
                    </div>
                </button>
                ...
                <button type="button" class="nav-item">
                    ...
                    <div class="nav-content">
                        <span class="nav-title">Karso Uditch</span>
                        <span class="nav-subtitle">Produksi karso</span>
                    </div>
                </button>
                ...
                <button type="button" class="nav-item">
                    ...
                    <div class="nav-content">
                        <span class="nav-title">Besi</span>
                        <span class="nav-subtitle">Material besi</span>
                    </div>
                </button>
...
const { currentTab, switchTab } = useTimbanganCBP();
