    ...
    const submitConcreteBatchingPlant = async () => {
        ...
        try {
            const payload = {
                ...
                datang: formSemenCBP.datang,
                bongkar: formSemenCBP.bongkar,
                suratjalan: formSemenCBP.suratjalan,
                shilo: formSemenCBP.shilo,
                ...
                beratmuatansuratjalan: formSemenCBP.beratmuatansuratjalan,
                selisih: formSemenCBP.selisih,
