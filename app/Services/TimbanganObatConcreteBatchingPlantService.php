...
class TimbanganObatConcreteBatchingPlantService
{
    ...
    public function getFiltered(int $plantId, ?int $menuJenisPlantId = null): Collection
    {
        return Timbangan::with([
            'timbanganobatcbp.material',
            'timbanganobatcbp.kendaraan',
            'timbanganobatcbp.driver',
            'timbanganobatcbp.customer',
            'timbanganobatcbp.suplier',
        ])
