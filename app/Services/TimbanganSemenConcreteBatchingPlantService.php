...
class TimbanganSemenConcreteBatchingPlantService
{
    ...
    public function getFiltered(int $plantId, ?int $menuJenisPlantId = null): Collection
    {
        return Timbangan::with([
            'timbangansemencbp.material',
            'timbangansemencbp.kendaraan',
            'timbangansemencbp.driver',
            'timbangansemencbp.customer',
            'timbangansemencbp.suplier',
        ])
