...
class AsphaltMixingPlantController extends Controller
{
    ...
    public function getTimbanganAMP(Request $request)
    {
    ...
    public function storeTimbanganAMP(Request $request)
    {
        // 1. Validasi Input
    ...
    public function updateTimbanganAMP(Request $request)
    {
        // 1. Validasi Input
        $validated = $request->validate([
    ...
    public function deleteTimbanganAMP(Request $request)
    {
